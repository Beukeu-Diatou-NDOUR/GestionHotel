...
import 'package:gestion_hotellerie/pages/reservationajout.dart';
import 'package:gestion_hotellerie/pages/reservationannuler.dart';
import 'package:gestion_hotellerie/pages/reservationliste.dart';

import 'chambrepage.dart';
import 'clientpage.dart';
import 'even_page.dart';
import 'facturepage.dart';
import 'statistiquepage.dart';
                  ...
                  ElevatedButton(
                    ...
                    onPressed: () => {
                      Navigator.push(
                          ...
                          PageRouteBuilder(
                              pageBuilder: (_, __, ___) =>
                                  const ReservationlistePage()))
                    },
                    child: const Text("Liste des reservations",
                        style: TextStyle(fontSize: 20, color: Colors.white)),
                  ),
                  SizedBox(
                    height: 25,
                  ...
                  ElevatedButton(
                    ...
                    onPressed: () => {
                      Navigator.push(
                          ...
                          PageRouteBuilder(
                              pageBuilder: (_, __, ___) =>
                                  const ReservationannulerPage()))
                    },
                    child: const Text("Annuler une reservation",
                        style: TextStyle(fontSize: 20, color: Colors.white)),
                  ),
